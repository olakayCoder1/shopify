                ...
                <div  className="g-6 flex h-full flex-wrap items-center justify-center lg:justify-between">
                    ...
                    <div className="mb-12 md:mb-0 w-10/12 sm:w-8/12 lg:w-5/12 xl:w-5/12">
                        <form className='flex flex-col space-y-4'>
                            <p className="mb-0 mr-4 text-lg">Set new password </p>
                            ...
                            <div className="text-center lg:text-left">
                                <button type="button"
                                    className="w-full md:w-fit inline-block rounded bg-blue-700 px-7 
                                        pb-2.5 pt-3 text-sm font-medium 
                                        uppercase leading-normal text-white transition 
                                        duration-150 ease-in-out hover:bg-blue-600  "
                                >
                                Reset 
                                </button> 
                            </div>
