  ...
  return (
    ...
    <div className="flex items-center min-h-screen p-4 bg-gray-100 lg:justify-center">
        ...
        <div className="p-5 bg-white md:flex-1">
            {currentForm === 'admin' ? (
                <>
                    <h3 className="my-4 text-2xl font-semibold text-gray-700">Admin Account Login</h3>
                        ...
                        <div className="flex flex-col space-y-4">
                            <div className="flex flex-col space-y-1">
                                <div className="flex items-center place-content-center">
                                    <label htmlFor="password" className="text-sm font-semibold text-gray-500">Not an admin?  </label>
                                    <Link to="/login" onClick={handleCustomerClick} className="text-sm text-blue-600 hover:underline focus:text-blue-800"> Login here</Link>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <>
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <Link to="#admin" onClick={handleAdminClick} className="text-sm text-blue-600 hover:underline focus:text-blue-800">Admin Login?</Link>
                    </div>
                    <div>
                        <button
                        type="submit"
