            ...
            <div className="flex justify-between py-6">
              <div className="text-gray-800 text-left flex-1 text-[18px]">
                ...
                <div className="text-left w-40">
                  <label  htmlFor="Discount" className="FormDigitsInput w-100 relative">
                    <div  className="">
                      <span > </span>
                    </div> 
                    ...
                    <div className="flex justify-between items-center">
                      <div>
                        <svg width="29" height="28" viewBox="0 0 29 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M7.977 20.948a1.031 1.031 0 102.062 0H7.977zm1.03-13.896l.827-.617a1.031 1.031 0 00-1.857.617h1.03zm10.39 13.896l-.825.617a1.031 1.031 0 001.857-.617h-1.032zM20.43 7.052a1.031 1.031 0 10-2.063 0h2.063zm-10.39 13.896V7.052H7.977v13.896h2.062zM8.182 7.67l10.39 13.895 1.651-1.235L9.833 6.435 8.183 7.67zm12.247 13.278V7.052h-2.063v13.896h2.063z" fill="#000"></path><path d="M5.773 14.269h16.453" stroke="#000" strokeWidth="2.063" strokeLinecap="round" strokeLinejoin="round"></path>
                        </svg>
                      </div> 
                      <div>
