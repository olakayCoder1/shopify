              ...
              <div className='min-w-[200px] max-w-[250px]'> 
                ...
                <form class="flex items-center">   
                    ...
                    <div class="relative w-full">
                        ...
                        <input type="search"  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5" placeholder="Search customer" required />
                    </div>
                </form>
              </div>
