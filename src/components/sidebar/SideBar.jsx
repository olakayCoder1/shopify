...
const SideBar = ({showSideBar}) => {
  ...
  return (
    <div
      className={`${showSideBar ? "" : "-translate-x-full"} fixed top-0 left-0 z-40 w-64 h-screen pt-14 transition-transform  bg-white border-r border-gray-200 md:translate-x-0 "`}
    ...
    >
      <div className=" overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800">
        ...
        <ul className="space-y-2 ">
            ...
            <SideBarLink Icon={FiUsers} linkName='Customers' isActive={false} linkHref='/admin/customers' />
            <SideBarLink Icon={TbUser} linkName='Profile' isActive={false} linkHref='profile' />
          ...
          <li>
            ...
            >
                <AiOutlineSetting className="flex-shrink-0 w-6 h-6 transition duration-75 group-hover:text-gray-900  "/>
          ...
          <li>
            ...
            >
                <AiOutlineQuestion className="flex-shrink-0 w-6 h-6  transition duration-75  group-hover:text-gray-900 "/>
      ...
      <div
        className=" absolute bottom-0 left-0 justify-center p-4 space-x-4 w-full lg:flex bg-white dark:bg-gray-800 z-20"
      >
        <a
          href="#"
